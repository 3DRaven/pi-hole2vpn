...
1. I found only pre-built droplets on DigitalOcean and a lot of instructions about setting up Pi-hole and WireGuard, but I do not want to configure
    ...
    on droplets.
2. When I use ad-blocker DNS, my phone stays cool and works for a full day (now it works 30 hours without charging) :) It is truly the best method to increase battery lifetime.
3. I dislike spyware.
